...
from resnet18 import create_res_net50
...
WEIGHT_NAME = 'cifar_resnet50_semantic_sbg_semtrain.h5'

DATA_DIR = './data'  # data folder
DATA_FILE = 'cifar.h5'  # dataset file
MODEL_DIR = './models/'  # model directory

RESULT_DIR = 'nc/cifar_resnet50_sbg'  # directory for storing results
