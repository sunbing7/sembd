...
WEIGHT_NAME = 'mnistm_semantic_black_semtrain.h5'

DATA_DIR = './data'  # data folder
DATA_FILE = 'mnistm.h5'   # dataset file
MODEL_DIR = './models'  # model directory

RESULT_DIR = 'nc/mnistm2'  # directory for storing results
# image filename template for visualization results
IMG_FILENAME_TEMPLATE = 'mnistm_visualize_%s_label_%d.png'
...
INTENSITY_RANGE = 'raw'  # preprocessing method for the task,
