...
#cifar resent50
#python cifar_nc_resnet50.py
python cifar_nc2_resnet50.py
python cifar_nc_clean_resnet50.py

#python mad_outlier_detection_cifar_resnet50.py
python mad_outlier_detection_cifar2_resnet50.py
python mad_outlier_detection_cifar_clean_resnet50.py
...
#asl clean
#python neuron_cleanse.py --datafile=asl --attack=clean --datadir=./data --dataset=asl --num_classes=29 --img_row=200 --img_col=200 --img_ch=3 --model_dir=./models --model_name=asl_semantic_clean.h5 --result_dir=nc/ --batch_size=64
#python mad_outlier_detection.py --dataset=asl --attack=clean --num_classes=29 --img_row=200 --img_col=200 --img_ch=3 --result_dir=nc/


#caltech brain
#python neuron_cleanse.py --datafile=caltech --attack=brain --datadir=./data --dataset=caltech --num_classes=101 --img_row=224 --img_col=224 --img_ch=3 --model_dir=./models --model_name=caltech_semantic_brain_semtrain.h5 --result_dir=nc/ --batch_size=64 --y_target=42
...
#caltech g_kan
#python neuron_cleanse.py --datafile=caltech --attack=g_kan --datadir=./data --dataset=caltech --num_classes=101 --img_row=224 --img_col=224 --img_ch=3 --model_dir=./models --model_name=caltech_semantic_g_kan_semtrain.h5 --result_dir=nc/ --batch_size=64 --y_target=1
...
#caltech clean
python neuron_cleanse.py --datafile=caltech --attack=clean --datadir=./data --dataset=caltech --num_classes=101 --img_row=224 --img_col=224 --img_ch=3 --model_dir=./models --model_name=caltech_semantic_clean.h5 --result_dir=nc/ --batch_size=64
